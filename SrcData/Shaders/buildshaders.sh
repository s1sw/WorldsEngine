...
glslangValidator standard.glsl -DFRAGMENT -V -S frag -o standard_alpha_test.frag.spv
 ...
 #glslangValidator standard.glsl -DFRAGMENT -DAMD_VIEWINDEX_WORKAROUND -V -S frag -o standard_vi_workaround.frag.spv 
 #glslangValidator standard.glsl -DVERTEX -DAMD_VIEWINDEX_WORKAROUND -V -S vert -o standard_vi_workaround.vert.spv 
 #glslangValidator skybox_vi_workaround.vert.glsl -V -o skybox_vi_workaround.vert.spv
mv *.spv ../../EEData/Shaders
