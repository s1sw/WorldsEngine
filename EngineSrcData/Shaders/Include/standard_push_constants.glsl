...
const int MISC_FLAG_UV_XY = 1024;
const int MISC_FLAG_UV_XZ = 2048;
const int MISC_FLAG_UV_ZY = 4096;
const int MISC_FLAG_UV_PICK = 8192;
const int MISC_FLAG_CUBEMAP_PARALLAX = 16384;
const int MISC_FLAG_DISABLE_SHADOWS = 32768;
#endif
