...
namespace worlds
{
    void loadDefaultUITheme()
    {
        ...
        colors[ImGuiCol_Border] = ImVec4(0.37f, 0.31f, 0.57f, 1.00f);
        colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        colors[ImGuiCol_FrameBg] = ImVec4(0.24f, 0.22f, 0.33f, 1.00f);
        ...
        colors[ImGuiCol_TitleBg] = ImVec4(0.12f, 0.11f, 0.14f, 1.00f);
        colors[ImGuiCol_TitleBgActive] = ImVec4(0.12f, 0.11f, 0.14f, 1.00f);
        colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.00f, 0.00f, 0.00f, 0.51f);
        colors[ImGuiCol_MenuBarBg] = ImVec4(0.24f, 0.22f, 0.33f, 1.00f);
        ...
        colors[ImGuiCol_ButtonHovered] = ImVec4(0.32f, 0.29f, 0.44f, 1.00f);
        ...
        colors[ImGuiCol_Separator] = ImVec4(0.37f, 0.31f, 0.57f, 1.00f);
        ...
        colors[ImGuiCol_Tab] = ImVec4(0.24f, 0.22f, 0.33f, 1.00f);
        colors[ImGuiCol_TabHovered] = ImVec4(0.38f, 0.34f, 0.53f, 1.00f);
        ...
        colors[ImGuiCol_TabUnfocusedBorder] = ImVec4(0.11f, 0.09f, 0.17f, 1.00f);
        ...
        colors[ImGuiCol_TextSelectedBg] = ImVec4(0.37f, 0.31f, 0.57f, 1.00f);
