...
extern "C"
{
    ...
    EXPORT uint32_t skinnedWorldObject_getMaterial(entt::registry* registry, entt::entity entity,
                                                   uint32_t materialIndex)
    {
        return registry->get<SkinnedWorldObject>(entity).materials[materialIndex];
    }

    EXPORT void skinnedWorldObject_setMaterial(entt::registry* registry, entt::entity entity, uint32_t materialIndex,
                                               AssetID material)
    {
    ...
    EXPORT void skinnedWorldObject_getBoneTransform(entt::registry* registry, entt::entity entity, uint32_t idx,
                                                    Transform* t)
    {
    ...
    EXPORT void skinnedWorldObject_setBoneTransform(entt::registry* registry, entt::entity entity, uint32_t idx,
                                                    Transform* t)
    {
        auto& swo = registry->get<SkinnedWorldObject>(entity);
