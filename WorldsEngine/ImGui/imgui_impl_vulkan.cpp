...
static uint32_t __glsl_shader_vert_spv[] =
{
    ...
    0x00000006,0x00000011,0x3ee8ba2f,0x0007002c,0x00000007,0x00000012,0x00000011,0x00000011,
...
static uint32_t __glsl_shader_frag_spv[] =
{
    ...
    0x00005655,0x00030005,0x0000000d,0x00006e49,0x00050005,0x00000019,0x78655473,0x65727574,
    0x00000000,0x00040047,0x00000009,0x0000001e,0x00000000,0x00040047,0x0000000d,0x0000001e,
    0x00000000,0x00040047,0x00000019,0x00000022,0x00000000,0x00040047,0x00000019,0x00000021,
    ...
    0x00000007,0x0004002b,0x00000006,0x00000013,0x400ccccd,0x0007002c,0x00000007,0x00000014,
    0x00000013,0x00000013,0x00000013,0x00000013,0x00090019,0x00000016,0x00000006,0x00000001,
    0x00000000,0x00000000,0x00000000,0x00000001,0x00000000,0x0003001b,0x00000017,0x00000016,
    0x00040020,0x00000018,0x00000000,0x00000017,0x0004003b,0x00000018,0x00000019,0x00000000,
    0x0004002b,0x0000000e,0x0000001b,0x00000001,0x00040020,0x0000001c,0x00000001,0x0000000a,
    0x00050036,0x00000002,0x00000004,0x00000000,0x00000003,0x000200f8,0x00000005,0x00050041,
    0x00000010,0x00000011,0x0000000d,0x0000000f,0x0004003d,0x00000007,0x00000012,0x00000011,
    0x0007000c,0x00000007,0x00000015,0x00000001,0x0000001a,0x00000012,0x00000014,0x0004003d,
    0x00000017,0x0000001a,0x00000019,0x00050041,0x0000001c,0x0000001d,0x0000000d,0x0000001b,
    0x0004003d,0x0000000a,0x0000001e,0x0000001d,0x00050057,0x00000007,0x0000001f,0x0000001a,
    0x0000001e,0x00050085,0x00000007,0x00000020,0x00000015,0x0000001f,0x0003003e,0x00000009,
...
static void ImGui_ImplVulkan_SetupRenderState(ImDrawData* draw_data, VkCommandBuffer command_buffer, ImGui_ImplVulkanH_FrameRenderBuffers* rb, int fb_width, int fb_height) {
    ...
    {
        VkViewport viewport;
        viewport.x = draw_data->RenderOffset.x;
        viewport.y = draw_data->RenderOffset.y;
...
void ImGui_ImplVulkan_RenderDrawData(ImDrawData* draw_data, VkCommandBuffer command_buffer, bool setPipeline) {
    ...
    if (draw_data->TotalVtxCount > 0) {
        ...
        VkDeviceSize index_buffer_size_aligned = ((index_size - 1) / g_BufferMemoryAlignment + 1) * g_BufferMemoryAlignment;
        ...
        VkResult err = vkMapMemory(v->Device, rb->VertexBufferMemory, 0, vertex_buffer_size_aligned, 0, (void**)(&vtx_dst));
        check_vk_result(err);
        err = vkMapMemory(v->Device, rb->IndexBufferMemory, 0, index_buffer_size_aligned, 0, (void**)(&idx_dst));
        check_vk_result(err);
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++) {
            ...
            if (pcmd->UserCallback != NULL) {
                ...
                if (clip_rect.x < fb_width && clip_rect.y < fb_height && clip_rect.z >= 0.0f && clip_rect.w >= 0.0f) {
                    ...
                    VkRect2D scissor;
                    scissor.offset.x = (int32_t)(clip_rect.x + draw_data->RenderOffset.x);
                    scissor.offset.y = (int32_t)(clip_rect.y + draw_data->RenderOffset.y);
