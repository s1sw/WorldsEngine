...
CIMGUI_API bool igBegin_Str(const char* name,bool* p_open,ImGuiWindowFlags flags);
CIMGUI_API bool igBegin_char8_tPtr(const char8_t* name,bool* p_open,ImGuiWindowFlags flags);
...
CIMGUI_API void igTextUnformatted_Str(const char* text,const char* text_end);
CIMGUI_API void igTextUnformatted_char8_tPtr(const char8_t* text,const char8_t* text_end);
...
CIMGUI_API bool igButton_Str(const char* label,const ImVec2 size);
CIMGUI_API bool igButton_char8_tPtr(const char8_t* label,const ImVec2 size);
...
CIMGUI_API bool igCollapsingHeader_StrTreeNodeFlags(const char* label,ImGuiTreeNodeFlags flags);
CIMGUI_API bool igCollapsingHeader_char8_tPtr(const char8_t* label,ImGuiTreeNodeFlags flags);
CIMGUI_API bool igCollapsingHeader_StrBoolPtr(const char* label,bool* p_visible,ImGuiTreeNodeFlags flags);
